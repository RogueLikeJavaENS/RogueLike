...
public class Room {
    ...
    /**
     * Add an gameElement.entity to the room
     * @param entity the gameElement.entity to add
     */
    ...
    /**
     * Remove an gameElement.entity in the room
     * @param entity the gameElement.entity to remove
     */
