...
public class Fighting {
    ...
    /**
     * This methods set the next gameElement.entity in the buffers according to the turnOrderList.
    ...
    /**
     * This methods is used to sort the TurnOrder according to the speed of each gameElement.entity.
    ...
    public static void main(String[] args) {
        ...
        Player p1 = new Player(new Position(1,2),"p1", InGameClasses.DUMMY, 1);
        p1.getStats().upInitiativeNatural(1);
        entities.add(p1);
        Player p2 = new Player(new Position(1,2),"p2", InGameClasses.DUMMY, 1);
        p2.getStats().upInitiativeNatural(1);
        entities.add(p2);
        Player p3 = new Player(new Position(1,2),"p3", InGameClasses.DUMMY, 1);
        p3.getStats().upInitiativeNatural(3);
        entities.add(p3);
        Player p4 = new Player(new Position(1,2),"p4",  InGameClasses.DUMMY, 1);
