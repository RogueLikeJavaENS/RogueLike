...
/**
 * This class describe all the living gameElement.entity that could exist, it could be the player or the monster or possibly a merchant, etc...
 * A living gameElement.entity is describe by his name, level, his maximum number of PV and PM, his current number of PV and PM
 *
 * @author Juliette
 */
...
public class LivingEntity extends AbstractEntity {
    ...
    public LivingEntity(Position position, String name, Colors color, AbstractStats stats) throws IllegalArgumentException {
        super(position, color,false,false); // false because a living gameElement.entity is never accessible.
        this.name = name;
        this.stats = stats;
    }
    ...
    public LivingEntity(Position position, String name, Colors color, AbstractStats stats, boolean isNPCAccessible) throws IllegalArgumentException {
        super(position, color,false, isNPCAccessible); // false because a living gameElement.entity is never accessible.
        this.name = name;
        this.stats = stats;
    }
