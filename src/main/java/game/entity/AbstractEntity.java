...
/**
 * This class represent an gameElement.entity, which is an object or something alive who/which can be on the map
 * The gameElement.entity has a position on the space, could be accessible or not and has sprites and color
 *
 * @author Juliette
 * */
...
public abstract class AbstractEntity implements Entity {
     ...
     * @param isPlayerAccessible true if another gameElement.entity could be on the same tile else false
     */
    ...
    /**
     * Return the position of the gameElement.entity
     * @return the position
     */
    @Override
    ...
    /***
     *Return the boolean which describe the accessibility of the gameElement.entity
    ...
    /**
     * Set the boolean which describe the accessibility of the gameElement.entity
    ...
    /**
     *Return the basic color of the gameElement.entity
     * @return a color
     */
    ...
    /**
     *Return the sprite tp print of the gameElement.entity
    ...
    /**
     *Return the basic sprite of the gameElement.entity
     * @param i 0 for the up sprites and 1 for the down sprites
     * @return a String
     */
    ...
    /**
     *Set the basic color of the gameElement.entity
    ...
    /**
     * Set the position of the gameElement.entity
